...
const SelectedSongList = ({ selectedSongs, removeSongFromSelected, handleClickPlay }) => {
  return(
        ...
        {selectedSongs.map((song, i) => {
          return(
            <div key={i} className='selected-song'>
              ...
              <i className={`play-icon fa-solid fa-play ${i}`} onClick={(e) => handleClickPlay(e.target.className.slice(27))}></i>
